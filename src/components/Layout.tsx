        ...
        <nav className="max-w-[120rem] mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex justify-between items-center h-20">
            ...
            <Link to="/" className="flex items-center space-x-3">
              <Bot className="h-9 w-9 text-electric-blue" />
              <span className="text-2xl font-heading font-bold bg-gradient-to-r from-electric-blue to-neon-green bg-clip-text text-transparent">
                Zapshere
              </span>
            </Link>
        ...
        <div className="max-w-[120rem] mx-auto px-6 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex space-x-6">
                <a href="#" className="text-light-gray hover:text-electric-blue transition-colors p-2">
              ...
              <ul className="space-y-4">
                {footerLinks.products.map((link) => (
                  <li key={link.name}>
                    <Link
                      to={link.href}
                      className="text-light-gray hover:text-electric-blue transition-colors font-paragraph py-1 block"
                    >
                      {link.name}
                    </Link>
                  </li>
          ...
          <div className="border-t border-light-gray/20 mt-16 pt-10 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-8 mt-6 md:mt-0">
              <Link to="/privacy" className="text-light-gray hover:text-electric-blue transition-colors font-paragraph text-sm py-2">
                Privacy Policy
              </Link>
              <Link to="/terms" className="text-light-gray hover:text-electric-blue transition-colors font-paragraph text-sm py-2">
                Terms of Service
              </Link>
            </div>
          </div>
